//------------------------------------------------------------------------
// <copyright file="JetFuelPoliciesHistoryDto.cs" company="Volaris">
...
namespace VOI.SISAC.Business.Dto.Process
{
    ...
    /// <summary>
    /// JetFuelPoliciesHistoryDto Class
    /// </summary>
    public class JetFuelPoliciesHistoryDto
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JetFuelPoliciesHistoryDto"/> class.
        /// </summary>
        public JetFuelPoliciesHistoryDto()
        {
