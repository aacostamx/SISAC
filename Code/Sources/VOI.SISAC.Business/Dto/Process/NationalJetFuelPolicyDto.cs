//------------------------------------------------------------------------
// <copyright file="NationalJetFuelPolicyDto.cs" company="Volaris">
...
{
    /// <summary>
    /// Jet fuel complement policy
    /// </summary>
    public class NationalJetFuelPolicyDto
    {
        /// <summary>
        ...
        /// </value>
        public NationalJetFuelPolicyControlDto NationalJetFuelPolicyControl { get; set; }
    }
}
