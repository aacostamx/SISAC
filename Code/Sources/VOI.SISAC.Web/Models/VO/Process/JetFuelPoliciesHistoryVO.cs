//------------------------------------------------------------------------
// <copyright file="PoliciesHistoryVO.cs" company="Volaris">
...
namespace VOI.SISAC.Web.Models.VO.Process
{
    ...
    /// <summary>
    /// PoliciesHistoryVO Class
    /// </summary>
    public class JetFuelPoliciesHistoryVO
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JetFuelPoliciesHistoryVO"/> class.
        /// </summary>
        public JetFuelPoliciesHistoryVO()
        {
