//------------------------------------------------------------------------
// <copyright file="NationalJetFuelInvoicePolicyVO.cs" company="Volaris">
...
namespace VOI.SISAC.Web.Models.VO.Process
{
    ...
    /// <summary>
    /// National Jet Fuel Invoice Policy View Object
    /// </summary>
    [DataContract(Name = "T_POLIZA")]
    public class NationalJetFuelInvoicePolicyVO
    {
        /// <summary>
