...
! function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        html = [sprintf('<div id="ToggleTable" name="ToggleTable" class="columns columns-%s btn-group pull-%s">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<button name="showColumns" type="button" class="btn btn-default' + (this.options.iconSize == undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
                sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.columns),
                ' <span class="caret"></span>',
                '</button>',
                '<ul class="dropdown-menu" role="menu">',
                '<li><label><input type="checkbox" id="checkAll" onClick="selectAll()"><strong>Select All</strong></label></li>');
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                sprintf('<input style="width:100%" class="form-control' + (this.options.iconSize === undefined ? '' : ' input-' + this.options.iconSize) + '" type="text" placeholder="%s">',
...
function selectAll() {
    ...
    if (hiddenColumns.length > 0) {
        for (i = 0; i < hiddenColumns.length; i++) {
            $('#' + tableID).bootstrapTable('showColumn', hiddenColumns[i].field)
        }
    }
