var NationalJetFuelErrorLogController = {
    GetPeriods: function () {
        $.ajax({
            url: '../NationalJetFuelLogError/GetPeriods',
            type: "GET",
            dataType: "JSON",
            async: false,
    ...
    GetDatesByPeriod: function () {
        ...
        $.ajax({
            url: '../NationalJetFuelLogError/GetDates',
    ...
    Init: function () {
        NationalJetFuelErrorLogController.GetPeriods();
    }
}

$(document).ready(NationalJetFuelErrorLogController.Init);