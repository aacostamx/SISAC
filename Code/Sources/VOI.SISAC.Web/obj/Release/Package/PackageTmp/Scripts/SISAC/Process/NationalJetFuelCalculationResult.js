var NationalJetFuelCalculationResultController = {
    ...
    GetDatesByPeriod: function () {
        ...
        if (periodCode) {
            $.ajax({
                url: '../NationalJetFuelCalculationResult/GetDates',
    ...
    PostForm: function (type) {
        ...
        if (form) {
            if (type === 'Policy') {
                form.action = '../Process/NationalJetFuelCalculationResult/CreatePolicy';
            }
            else if (type === 'Group') {
...
$(document).ready(function () {
    NationalJetFuelCalculationResultController.SetAirportComboConfiguration();
    NationalJetFuelCalculationResultController.SetAirlineComboConfiguration();
    NationalJetFuelCalculationResultController.SetServiceComboConfiguration();
    NationalJetFuelCalculationResultController.SetProviderComboConfiguration();
    NationalJetFuelCalculationResultController.SetPeriodComboConfiguration();
});