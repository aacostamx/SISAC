//------------------------------------------------------------------------
// <copyright file="JetFuelPolicyConfiguration.cs" company="Volaris">
...
namespace VOI.SISAC.Dal.Configuration.Process
{
    ...
    public class JetFuelPolicyConfiguration : EntityTypeConfiguration<JetFuelPolicy>
    {
        /// <summary>
        /// The schema name
        /// </summary>
        ...
        /// </summary>
        public JetFuelPolicyConfiguration()
        {
            // Defines the table's name and schema
            this.ToTable("JetFuelPolicy", this.schemaName);
