//------------------------------------------------------------------------
// <copyright file="JetFuelPolicyControl.cs" company="Volaris">
...
namespace VOI.SISAC.Entities.Process
{
    ...
    /// <summary>
    /// JetFuelPolicyControl Entity Class
    /// </summary>
    public class JetFuelPolicyControl
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the jet fuel policy.
        /// </summary>
        /// <value>
        /// The jet fuel policy.
        /// </value>
        public virtual IList<JetFuelPolicy> JetFuelPolicies { get; set; }
    }
}
