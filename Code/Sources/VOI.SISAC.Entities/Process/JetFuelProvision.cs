//------------------------------------------------------------------------
// <copyright file="JetFuelProvision.cs" company="Volaris">
...
namespace VOI.SISAC.Entities.Process
{
    ...
    /// <summary>
    /// Jet fuel provision entity
    /// </summary>
    public class JetFuelProvision
    {
        /// <summary>
        ...
        /////// </value>
        ////public virtual JetFuelPolicyControl JetFuelPolicyControl { get; set; }
        ...
        /// </value>
        public virtual JetFuelProcess JetFuelProcess { get; set; }
    }
}